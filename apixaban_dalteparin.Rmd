...
meta_datm2_reml <- rma(yi, vi, method="REML", data=dat_m2, x)
meta_datm2_reml
...
cf <- structure(list(
          mean = c(rep(NA, 1), exp(dat_m$y), meta_m$pred, rep(NA, 4), exp(dat_nm$y), meta_nm$pred, rep(NA, 4), exp(dat_te$y), meta_te$pred,NA),
